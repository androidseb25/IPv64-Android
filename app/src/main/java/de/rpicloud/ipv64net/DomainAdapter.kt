...
import de.rpicloud.ipv64net.databinding.AdapterDomainBinding
...
class DomainAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val binding = AdapterDomainBinding.bind(view)
...
//        }
    ...
    override fun onBindViewHolder(
        ...
        with(viewHolder) {
            ...
            binding.ipCircle.setCardBackgroundColor(
        ...
        GlobalScope.launch(Dispatchers.Default) {
            ...
            if (listOfDomains.subdomains == null) {
                launch(Dispatchers.Main) {
                    Toast.makeText(activity, "Keine Domainen gefunden!", Toast.LENGTH_LONG).show()
